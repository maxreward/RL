...
- ## About Reinforcement Learning
    - ### Faces of Reinforcement Learning
        - ![](https://firebasestorage.googleapis.com/v0/b/firescript-577a2.appspot.com/o/imgs%2Fapp%2Fchrisliu%2F8p26AtVBXq.png?alt=media&token=34e13552-a10b-4aad-907f-f823ae283da2)
    - ### Branches of Machine Learning
        - ![](https://firebasestorage.googleapis.com/v0/b/firescript-577a2.appspot.com/o/imgs%2Fapp%2Fchrisliu%2FwVgUc5_SWZ.png?alt=media&token=5a9e87a9-9012-41d3-b80e-17670fbac1b6)
...
- ## The Reinforcement Learning Problem
    ...
    - ### Agent and Environment
        - ![](https://firebasestorage.googleapis.com/v0/b/firescript-577a2.appspot.com/o/imgs%2Fapp%2Fchrisliu%2F7CSt-lTtsn.png?alt=media&token=a5766dfb-afff-4486-a310-adc29e6a1284)
...
$$\begin{aligned} \mathcal{P}_{s s^{\prime}}^{a} &=\mathbb{P}\left[S_{t+1}=s^{\prime} \mid S_{t}=s, A_{t}=a\right] \\ \mathcal{R}_{s}^{a} &=\mathbb{E}\left[R_{t+1} \mid S_{t}=s, A_{t}=a\right] \end{aligned}$$
    - ### Categorizing RL Agents
        ...
        - Model-based
            ...
            - Model
    - ### RL Agent Taxonomy
        - ![](https://firebasestorage.googleapis.com/v0/b/firescript-577a2.appspot.com/o/imgs%2Fapp%2Fchrisliu%2FlsyUV4qnMN.png?alt=media&token=62961704-03a3-4658-a677-5170b1b23ed2)
